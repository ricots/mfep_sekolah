...
import com.sekolah.admin.system.adapter.adapter_kepsek.adapter_data_pertanyaan;
...
public class data_pertanyaan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_pertanyaan);
        Bundle bundle = getIntent().getExtras();
        id_kat = bundle.getString("id_kat");
//        nip = bundle.getString("kirim_nip");
//        MDToast mdToast = MDToast.makeText(data_pertanyaan.this, nip, MDToast.LENGTH_LONG, MDToast.TYPE_WARNING);
//        mdToast.show();
        ...
        list_daftar = (RecyclerView) findViewById(R.id.recyle_data_tanya);
        ...
        getData();
        adp_daftar = new adapter_data_pertanyaan(datanya, this);
        list_daftar.setAdapter(adp_daftar);
    }

    public void getData() {
        final ProgressDialog loading = ProgressDialog.show(data_pertanyaan.this,"Loading Data", "Please wait...",false,false);
        JsonObjectRequest jsonRequest = new JsonObjectRequest(Request.Method.GET, config.LIST_PERTANYAAN + id_kat,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        MDToast mdToast = MDToast.makeText(data_pertanyaan.this, error.getMessage(), MDToast.LENGTH_LONG, MDToast.TYPE_WARNING);
                        mdToast.show();
                    }
                });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.load){
            ...
            MDToast mdToast = MDToast.makeText(data_pertanyaan.this, "cek koneksi internet", MDToast.LENGTH_LONG, MDToast.TYPE_WARNING);
            mdToast.show();
            return true;
        }
