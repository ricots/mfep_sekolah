...
public class hasil_penilaian extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list_daftar = (RecyclerView) findViewById(R.id.recyle_detail_hasil);
    ...
    public void getData() {
        final ProgressDialog loading = ProgressDialog.show(hasil_penilaian.this,"Loading Data", "Please wait...",false,false);
        JsonObjectRequest jsonRequest = new JsonObjectRequest(Request.Method.GET, config.LIST_DETAIL_PENILAIAN + welcome,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        MDToast mdToast = MDToast.makeText(hasil_penilaian.this, error.getMessage(), MDToast.LENGTH_LONG, MDToast.TYPE_WARNING);
                        mdToast.show();
                    }
                });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.load){
            ...
            MDToast mdToast = MDToast.makeText(hasil_penilaian.this, "cek koneksi internet", MDToast.LENGTH_LONG, MDToast.TYPE_WARNING);
            mdToast.show();
            return true;
        }
