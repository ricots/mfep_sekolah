...
import com.sekolah.admin.system.adapter.adapter_kepsek.adapter_daftar_guru;
...
public class daftar_guru extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list_daftar = (RecyclerView) findViewById(R.id.recyle_guru);
...
//        list_daftar.setLayoutManager(layoutManager);
        ...
        getData();
        adp_daftar = new adapter_daftar_guru(datanya, this);
        list_daftar.setAdapter(adp_daftar);
    }

    public void getData() {
        final ProgressDialog loading = ProgressDialog.show(daftar_guru.this,"Loading Data", "Please wait...",false,false);
        JsonObjectRequest jsonRequest = new JsonObjectRequest(Request.Method.GET, config.LIST_GURU,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        MDToast mdToast = MDToast.makeText(daftar_guru.this, error.getMessage(), MDToast.LENGTH_LONG, MDToast.TYPE_WARNING);
                        mdToast.show();
                    }
                });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.load){
            ...
            MDToast mdToast = MDToast.makeText(daftar_guru.this, "cek koneksi internet", MDToast.LENGTH_LONG, MDToast.TYPE_WARNING);
            mdToast.show();
            return true;
        }
